...
public class AlteraCadastroUsuario extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_alteracadastro);

        spinerEst = (Spinner) findViewById(R.id.spinerAltEstado);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btnCadVolt) {
            Intent Cadvoltar = new Intent(this, PerfilCliente.class);
